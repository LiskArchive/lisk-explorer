Feature: Delegate Monitor
  Scenario: should show delegates, last block, next forgers, ...
    ...
    And I should see table "active delegates" with 101 rows starting with:
      ...
      |------|-------------------|--------------|---------------------|--------------|--------|----------------------|---------------------|
      | 1    | /genesis_\d{1,3}/ | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | 2    | /genesis_\d{1,3}/ | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | 3    | /genesis_\d{1,3}/ | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
  ...
  Scenario: should allow to sort active delegates
    ...
    Then I should see table "active delegates" with 101 rows starting with:
      | Rank      | Name      | Address      | Forged              | Forging time | Status | Productivity         | Approval            |
      |-----------|-----------|--------------|---------------------|--------------|--------|----------------------|---------------------|
      | /\d{1,3}/ | genesis_1 | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | /\d{1,3}/ | genesis_2 | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | /\d{1,3}/ | genesis_3 | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | /\d{1,3}/ | genesis_4 | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
      | /\d{1,3}/ | genesis_5 | /\d{10,20}L/ | /~1,\d{3} LSK/      | /.+/         |        | /\d{2,3}(\.\d{2})?%/ |/\d{2,3}(\.\d{2})?%/ |
