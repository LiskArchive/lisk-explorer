Feature: Top Accounts page
  Scenario: should show title, summary, and transactions
    ...
    And I should see table "top accounts" with 50 rows starting with:
      ...
      |------|-----------------------|-----------------------|--------|----------------|
      | 1    | 16313739661670634666L | 99,675,450.108366 LSK | 99.68% | N/A            |
      | 2    | 4401082358022424760L  | 9,971 LSK             | 0.01%  | gottavoteemall |
      | 3    | 18234943547133247982L | 6,229.88999424 LSK    | 0.01%  | N/A            |
